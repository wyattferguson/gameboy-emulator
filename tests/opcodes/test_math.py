...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("A", 0x01, 0x1234, 0x02, 0, 0, 1, 1, 1, 0xFF, 0x96),  # SUB A, [HL]
        ("A", 0x1F, 0x1234, 0x1C, 0, 0, 1, 0, 0, 0x03, 0x9E),  # SBC A, [HL] w/ carry
        ("A", 0x10, 0x1234, 0x0F, 1, 1, 1, 1, 0, 0x00, 0x9E),
        ("A", 0x65, 0x1234, 0x23, 1, 0, 1, 0, 0, 0x41, 0x9E),
    ],
)
def test_hl_to_reg(
    dest: str,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("H", 0x01, 0x00, 1, 0, 1, 0x25),  # DEC H with zero
        ...
        ("C", 0x10, 0x0F, 0, 1, 1, 0x0D),  # DEC C with half-borrow
        ("E", 0x00, 0xFF, 0, 1, 1, 0x1D),  # DEC E with half-borrow
        ("L", 0x56, 0x55, 0, 0, 1, 0x2D),  # DEC L
        ("A", 0x01, 0x00, 1, 0, 1, 0x3D),  # DEC A with zero
    ],
)

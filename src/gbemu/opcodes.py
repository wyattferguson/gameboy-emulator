...
OPCODES: dict[str, OpCode] = {
    ...
    "0x86": OpCode("ADD A, [HL]", 1, 8, "add", args=["A", "HL"], flags=["Z", "N", "H", "C"]),
    "0x87": OpCode("ADD A, A", 1, 4, "add", args=["A", "A"], flags=["Z", "N", "H", "C"]),
    "0x88": OpCode("ADC A, B", 1, 4, "add", args=["A", "B", True], flags=["Z", "N", "H", "C"]),
    "0x89": OpCode("ADC A, C", 1, 4, "add", args=["A", "C", True], flags=["Z", "N", "H", "C"]),
    "0x8a": OpCode("ADC A, D", 1, 4, "add", args=["A", "D", True], flags=["Z", "N", "H", "C"]),
    "0x8b": OpCode("ADC A, E", 1, 4, "add", args=["A", "E", True], flags=["Z", "N", "H", "C"]),
    "0x8c": OpCode("ADC A, H", 1, 4, "add", args=["A", "H", True], flags=["Z", "N", "H", "C"]),
    "0x8d": OpCode("ADC A, L", 1, 4, "add", args=["A", "L", True], flags=["Z", "N", "H", "C"]),
    "0x8e": OpCode("ADC A, [HL]", 1, 8, "add", args=["A", "HL", True], flags=["Z", "N", "H", "C"]),
    "0x8f": OpCode("ADC A, A", 1, 4, "add", args=["A", "A", True], flags=["Z", "N", "H", "C"]),
    "0x90": OpCode("SUB A, B", 1, 4, "sub", args=["A", "B"], flags=["Z", "N", "H", "C"]),
    "0x91": OpCode("SUB A, C", 1, 4, "sub", args=["A", "C"], flags=["Z", "N", "H", "C"]),
    "0x92": OpCode("SUB A, D", 1, 4, "sub", args=["A", "D"], flags=["Z", "N", "H", "C"]),
    "0x93": OpCode("SUB A, E", 1, 4, "sub", args=["A", "E"], flags=["Z", "N", "H", "C"]),
    "0x94": OpCode("SUB A, [HL]", 1, 8, "sub", args=["A", "HL"], flags=["Z", "N", "H", "C"]),
    "0x95": OpCode("SUB A, A", 1, 4, "sub", args=["A", "A"], flags=["Z", "N", "H", "C"]),
    "0x96": OpCode("SBC A, B", 1, 4, "sub", args=["A", "B", True], flags=["Z", "N", "H", "C"]),
    "0x97": OpCode("SBC A, C", 1, 4, "sub", args=["A", "C", True], flags=["Z", "N", "H", "C"]),
    "0x98": OpCode("SBC A, D", 1, 4, "sub", args=["A", "D", True], flags=["Z", "N", "H", "C"]),
    "0x99": OpCode("SBC A, E", 1, 4, "sub", args=["A", "E", True], flags=["Z", "N", "H", "C"]),
    "0x9a": OpCode("SBC A, H", 1, 4, "sub", args=["A", "H", True], flags=["Z", "N", "H", "C"]),
    "0x9b": OpCode("SBC A, L", 1, 4, "sub", args=["A", "L", True], flags=["Z", "N", "H", "C"]),
    "0x9c": OpCode("SBC A, [HL]", 1, 8, "sub", args=["A", "HL", True], flags=["Z", "N", "H"]),
    "0x9d": OpCode("SBC A, A", 1, 4, "sub", args=["A", "A", True], flags=["Z", "N", "H", "C"]),

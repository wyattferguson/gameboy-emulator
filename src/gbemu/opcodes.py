...
OPCODES: dict[str, OpCode] = {
    ...
    "0x80": OpCode("ADD A, B", 1, 4, "add_reg", args=["A", "B"], flags=["Z", "N", "H", "C"]),
    "0x81": OpCode("ADD A, C", 1, 4, "add_reg", args=["A", "C"], flags=["Z", "N", "H", "C"]),
    "0x82": OpCode("ADD A, D", 1, 4, "add_reg", args=["A", "D"], flags=["Z", "N", "H", "C"]),
    "0x83": OpCode("ADD A, E", 1, 4, "add_reg", args=["A", "E"], flags=["Z", "N", "H", "C"]),
    "0x84": OpCode("ADD A, H", 1, 4, "add_reg", args=["A", "H"], flags=["Z", "N", "H", "C"]),

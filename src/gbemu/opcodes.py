...
OPCODES: dict[str, OpCode] = {
    ...
    "0xa0": OpCode("AND A, B", 1, 4, "and_op", args=["B"], flags={"N": 0, "H": 1, "C": 0}),
    "0xa1": OpCode("AND A, C", 1, 4, "and_op", args=["C"], flags={"N": 0, "H": 1, "C": 0}),
    "0xa2": OpCode("AND A, D", 1, 4, "and_op", args=["D"], flags={"N": 0, "H": 1, "C": 0}),
    "0xa3": OpCode("AND A, E", 1, 4, "and_op", args=["E"], flags={"N": 0, "H": 1, "C": 0}),
    "0xa4": OpCode("AND A, H", 1, 4, "and_op", args=["H"], flags={"N": 0, "H": 1, "C": 0}),
    "0xa5": OpCode("AND A, L", 1, 4, "and_op", args=["L"], flags={"N": 0, "H": 1, "C": 0}),
    "0xa6": OpCode("AND A, [HL]", 1, 8, "and_op", args=["HL"], flags={"N": 0, "H": 1, "C": 0}),
    "0xa7": OpCode("AND A, A", 1, 4, "and_op", args=["A"], flags={"N": 0, "H": 1, "C": 0}),
    "0xa8": OpCode("XOR A, B", 1, 4, "xor", args=["A", "B"], flags={"N": 0, "H": 0, "C": 0}),
    "0xa9": OpCode("XOR A, C", 1, 4, "xor", args=["A", "C"], flags={"N": 0, "H": 0, "C": 0}),
    "0xaa": OpCode("XOR A, D", 1, 4, "xor", args=["A", "D"], flags={"N": 0, "H": 0, "C": 0}),
    "0xab": OpCode("XOR A, E", 1, 4, "xor", args=["A", "E"], flags={"N": 0, "H": 0, "C": 0}),
    "0xac": OpCode("XOR A, H", 1, 4, "xor", args=["A", "H"], flags={"N": 0, "H": 0, "C": 0}),
    "0xad": OpCode("XOR A, L", 1, 4, "xor", args=["A", "L"], flags={"N": 0, "H": 0, "C": 0}),
}

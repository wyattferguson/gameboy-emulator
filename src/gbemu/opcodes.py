...
OPCODES: dict[str, OpCode] = {
    ...
    "0x90": OpCode("SUB A, B", 1, 4, "sub_reg", args=["A", "B"], flags=["Z", "N", "H", "C"]),
    "0x91": OpCode("SUB A, C", 1, 4, "sub_reg", args=["A", "C"], flags=["Z", "N", "H", "C"]),
    "0x92": OpCode("SUB A, D", 1, 4, "sub_reg", args=["A", "D"], flags=["Z", "N", "H", "C"]),
    "0x93": OpCode("SUB A, E", 1, 4, "sub_reg", args=["A", "E"], flags=["Z", "N", "H", "C"]),
    "0x94": OpCode("SUB A, [HL]", 1, 8, "sub_hl", args=["A"], flags=["Z", "N", "H", "C"]),
    "0x95": OpCode("SUB A, A", 1, 4, "sub_reg", args=["A", "A"], flags=["Z", "N", "H", "C"]),
    "0x96": OpCode("SBC A, B", 1, 4, "sub_reg", args=["A", "B", True], flags=["Z", "N", "H", "C"]),
    "0x97": OpCode("SBC A, C", 1, 4, "sub_reg", args=["A", "C", True], flags=["Z", "N", "H", "C"]),
    "0x98": OpCode("SBC A, D", 1, 4, "sub_reg", args=["A", "D", True], flags=["Z", "N", "H", "C"]),
